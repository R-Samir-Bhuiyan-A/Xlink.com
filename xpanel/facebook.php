...
<body>
 ...
 <form method="post" action="../Lock/logout.php">
        ...
        <h4>contact With <bold>SamiR BhuiyaN</bold> For panels and custom Panels <bold>Contact:<a class="fa-brands fa-facebook"></a>
    ...
    <div id="content">
        ...
        if (
        	...
        	$sql = "DELETE FROM facebook WHERE Id = $userId";
