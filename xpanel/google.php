...
<body>
    ...
    <nav>
        ...
        <h4>contact With R.SamiR.BhuiyaN.A For panels and custom Panels <bold>Contact:<a class="fa-brands fa-facebook"></a>
    ...
    <div id="content">
        ...
        if (
        	...
        	$sql = "DELETE FROM gmail WHERE Id = $userId";
